package org.vmstudio.visorflightonelytras.core.client.overlays;
...
@RegisterVROverlayTemplate(
        id = VROverlayTemplateFlight.ID,
        name = VROverlayTemplateFlight.NAME,
        description = VROverlayTemplateFlight.DESCRIPTION
)
public class VROverlayTemplateFlight extends VROverlayTemplateScreen {
    public static final String ID = "template_flight";
    public static final String NAME = "Flight template";
    public static final String DESCRIPTION = "Flight overlay template";

    private final Component text = Component.literal("Flight Overlay Template");

    public VROverlayTemplateFlight(@NotNull VisorAddon owner, @NotNull String id) {
        super(owner, id);
